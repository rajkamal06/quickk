...
class Provider extends GetConnect {
  ...
  Future<dynamic> aboutus() async {
    var res = await get('https://quickk.frantic.in/Home/about', headers: {
  ...
  Future<dynamic> tc() async {
    var res = await get('https://quickk.frantic.in/home/tc', headers: {
      "Accept": "application/json",
    });
    if (res.statusCode == 200 || res.statusCode == 201) {
      return res.body;
  ...
  Future<dynamic> contact() async {
    ...
    var res = await get("https://quickk.frantic.in/home/contact", headers: {
      "Accept": "application/json",
    });
    if (res.statusCode == 200 || res.statusCode == 201) {
      return res.body;
