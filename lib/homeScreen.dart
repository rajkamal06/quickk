                                                                      ...
                                                                      children: [
                                                                        InkWell(
                                                                          onTap:
                                                                            ...
                                                                            setState(() {
                                                                              loading = true;
                                                                              if (int.parse(topProductDataList[index].qty) > 1) {
                                                                                ...
                                                                                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Item quantity can not lesser than 1.")));
                                                                      ...
                                                                      children: [
                                                                        InkWell(
                                                                          onTap:
                                                                              () {
                                                                            setState(() {
                                                                              if (int.parse(recomProductDataList[index].qty) > 1) {
